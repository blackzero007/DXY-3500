  ...
  return (
    <header className="w-full flex flex-col gap-3 py-4 px-4 sm:flex-row sm:items-center sm:justify-between sm:px-6">
      <div className="flex items-center gap-2 min-w-0">
        ...
        <h1 className="text-xl font-bold text-gray-800 dark:text-white truncate">每日单词拼图</h1>
      </div>
      ...
      <div className="flex flex-wrap items-center gap-2 sm:justify-end sm:gap-4">
        ...
        <div className="relative" ref={menuRef}>
          <button
            ...
            title="设置"
          >
            <Settings className={['w-4 h-4 transition-transform', menuOpen ? 'rotate-90 text-indigo-600' : 'text-indigo-500'].join(' ')} />
          </button>
